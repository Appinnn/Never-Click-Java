...
<div id="boardWrap">
	...
	<div id="boardBox">
		...
		<!-- 페이징 -->
<style>
	#pageNumList{ list-style:none; padding: 30px; margin:0; display: flex; justify-content: center;}
	#pageNumList li{ width: 50px; text-align: center;}
	#pageNumList .nowPage{ background: #ccc; font-weight: 800;}
</style>			
		<div id="pageNumbers">
			<ul id="pageNumList">
				<a href="/board.do?page=${pageNum - skip < 1 ? 1 : pageNum - skip }"><i class="bi bi-caret-left-square-fill"></i> </a>
				...
				<a href="/board.do?page=${pageNum + skip > pageTotalNum ? pageTotalNum : pageNum+skip }"><i class="bi bi-caret-right-square-fill"></i></a>
			</ul>
