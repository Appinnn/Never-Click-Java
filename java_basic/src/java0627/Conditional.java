...
public class Conditional {
	...
	public static void main(String[] args) 
	{
		...
		//switch - 실행 조건을 case로 설정하여 case와 일치하는 값을 경우 발동 되는 조건문
		
		// 지렁이 게임을 만든다. 방향키는 w a s d 이고
		// p 키는 일시정지, O키는 계속하기, i키는 처음부터 다시시작
		// ctrl + s 는 게임 시작이라고 한다면
		 ...
		 *  	}
		 *  
		 *  조건식이 == 연산자가 사용된다면 switch 로 시작하는것을 고려 해보기.
		 *  
		 *  
		 *  
		 */
		...
		// 가로가 또는 세로의 길이가 크다면 직각사각형
		// 가로와 세로의 길이가 같다면 정사각형 이라고 출력하세요
		// switch 문으로 (if문 절대 쓰지말고)
		...
		// switch 문에서 default은 한번만 사용
		// switch에 들어온 값이 case에 일치하는게 없다면 default 실행된다.
		// 주어진 case 와 일치하는게 하나도 없으면 default만 실행 하고 종료
