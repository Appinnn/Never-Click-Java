...
//		System.out.println("크기 증가 후 : " + Arrays.toString(num));
		...
		// 문자열에 특정 문자나 문자열 포함여부는 .contains()
		// 다음 주소중 선화동에 주소만 추출하여 배열에 저장
		// 배열에 잘 저장되었는지 확인 후 출력은 Arrays 이용하여 출력
		
		
//		String addr[] = new String[] {"대전 중구 선화동 25","대전 중구 선화동 92","대전 서구 둔산동 111"
//										,"대전 서구 둔산동 1023","대전 유성구 노은동 93","대전 중구 대흥동 932"
//										,"대전 동구 가양동 945","대전 중구 선화동 1234","대전 중구 대흥동23"
//										,"대전 중구 선화동 984"}; 
//		
