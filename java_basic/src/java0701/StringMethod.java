...
public class StringMethod {
	...
	public static void main(String[] args) 
	{
		...
		// 프로그램에서 사용되는 데이터중 70%정도는 문자열 데이터 이다.
		...
		// 문자열 포함 여부 - 문자열 안에 포함되어 있나?
		// contains
		// indexOf (-1이 나온다면 포함되지 않은것)
...
//		
//		// 문자열 변환
//		String 뽀뽀뽀 = "아빠가 출근 할때 뽀뽀뽀 엄마가 안아줘도 뽀뽀뽀 만나면 반갑다고 뽀뽀뽀";
//		
