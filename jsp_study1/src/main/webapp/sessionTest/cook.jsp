...
<%
	...
	{
		if(cook.getName().equals("food"))
		{
			food = cook.getValue()+"-"+food;
		}
		if( cook.getName().equals("price"))
		{
			price = cook.getValue()+"-"+price;
		}
		if( cook.getName().equals("rest"))
		{
			rest = cook.getValue()+"-"+rest;
		}
	}
	...
	// 쿠키의 종류
	//	세션 쿠키 - 세션처럼 정해진 기간없이 클라이언트가 연결을 끊으면 쿠키도 삭제됨
	//	영구 쿠키 - 기간이 정해져있는 쿠키
...
// 		{
// 			c.setMaxAge(0);
// 			response.addCookie(c); // 쿠키의 만료 시간을 0으로 변경하게 클라이언트에게 전송
// 			break;
// 		}
// 	}
